        ...
        >
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className={`w-10 h-10 rounded-full shadow-lg transition-all duration-200 border-2 ${
            ...
            >
              <svg className={`w-5 h-5 ${showSettings ? 'text-orange-500 drop-shadow-[0_0_4px_rgba(249,115,22,0.8)]' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span 
                className={`font-medium text-sm ${showSettings ? 'drop-shadow-[0_0_4px_rgba(249,115,22,0.8)]' : ''}`}
        ...
        >
          ...
          <div className="absolute right-6 flex items-center gap-3" style={{ transform: 'translateY(-20px)' }}>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.15 }}
              whileTap={{ scale: 0.9 }}
              className={`w-8 h-8 rounded-full shadow-lg transition-all duration-200 border-2 ${
                theme === 'dark' ? 'border-white' : 'border-black'
              }`}
              style={{ backgroundColor: color }}
            />
        ...
        {showColorPicker && (
          <>
            ...
            <motion.div
              ...
              className={`fixed rounded-2xl shadow-[0_25px_80px_rgba(0,0,0,0.8)] p-6 z-50 backdrop-blur-xl ${
              ...
              <div className="grid grid-cols-4 gap-3">
                {PRESET_COLORS.map((preset) => (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.15 }}
                    whileTap={{ scale: 0.95 }}
                    className={`relative w-6 h-6 rounded-full transition-all border-2 ${
                      theme === 'dark' ? 'border-white' : 'border-black'
                    } ${
                      color === preset.color
                        ? theme === 'dark' ? 'ring-4 ring-zinc-700' : 'ring-4 ring-gray-400'
                        : ''
                    }`}
